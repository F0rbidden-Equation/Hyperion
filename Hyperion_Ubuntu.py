...
c13 = (colored("[13]", 'blue'))
c13_a = (colored(" Detected Type DB mssql/Mysql/...", 'green'))
c14 = (colored("[14]", 'blue'))
...
def Menu_EmailR():
    ...
    search_name = subprocess.run("cd ./theHarvester/ && python3 theHarvester.py -d " + mail_name + " -l 500 -b google", shell=True)
